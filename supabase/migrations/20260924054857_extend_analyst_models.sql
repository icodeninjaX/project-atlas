-- Keep Analyst's database validation aligned with its separate server allowlist.
...
begin
  if requesting_user is null or p_type not in ('spending_change','debt_progress','task_focus','career_pipeline','goal_progress','weekly_review_trends','signals_summary')
    or p_model not in ('gpt-4o-mini-2024-07-18','gpt-4.1-mini','gpt-5.4-nano','gpt-5.4-mini','gpt-4o','gpt-5.4') then return null; end if;
