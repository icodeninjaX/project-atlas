...
begin
  ...
  select scoped.id, scoped.occurred_on, scoped.occurred_at, scoped.occurred_precision, scoped.module, scoped.action,
    scoped.title, scoped.description, scoped.amount_centavos, scoped.amount_direction, scoped.metric_label,
    scoped.metric_value, case when scoped.source_available then scoped.source_href else null end,
