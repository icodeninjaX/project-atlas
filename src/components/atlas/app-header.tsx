...
export function AppHeader({ displayName }: { displayName?: string | null }) {
  return (
    <header className="border-border bg-background/95 sticky top-0 z-30 flex min-h-16 w-full max-w-full min-w-0 items-center justify-between border-b px-4 pt-[env(safe-area-inset-top)] backdrop-blur sm:px-6 lg:static lg:min-h-18 lg:px-8 lg:pt-0">
